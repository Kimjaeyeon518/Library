...
//    @Bean
//    public HandlerInterceptor handlerInterceptorBean() throws Exception {
...
//            .and()
                ...
                .antMatchers("/signIn", "/signUp", "/", "/login").permitAll()    // 누구나 접근 가능
                .antMatchers(HttpMethod.GET, "/books").permitAll()    // 누구나 접근 가능
                ...
                .antMatchers(HttpMethod.GET, "/books/edit/**", "/books/add").hasRole("ADMIN") // ADMIN만 접근 가능
...
//              jwt 연동 로그인을 위해 주석 처리.
            .and()
                ...
                .defaultSuccessUrl("/")     // 로그인 성공 시 redirect 하는 url
            .and()
                .logout()       // 로그아웃에 대한 설정
